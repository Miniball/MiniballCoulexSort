...
MBSorter::MBSorter() {
	...
	text_daq_dir->Resize( 500, text_daq_dir->GetDefaultHeight() );
	sub_frame_1->AddFrame( text_daq_dir, new TGLayoutHints( kLHintsRight | kLHintsExpandX, 2, 2, 2, 2 ) );
	...
	// TreeAna
	but_ana = new TGTextButton( comp_frame_3, "Make histograms", -1, TGTextButton::GetDefaultGC()(),
							   TGTextButton::GetDefaultFontStruct(), kRaisedFrame );
	...
	text_daq_dir->SetText( "/mbdata/miniball/bonus-170728" );
	text_local_dir->SetText( "/media/MinballBackup/clx107/medfiles" );

	text_add_file->SetText( "22Ne_107Ag_Pos4_003" );

	text_settings->SetText( "/media/MinballBackup/clx107/MBSettings2017_CLX.dat" );
	check_source->SetOn();

	text_outfile->SetText( "/media/MinballBackup/clx107/rootfiles/22Ne_107Ag_" );
	text_calfile->SetText( "/media/MinballBackup/clx107/calfiles/calibration-online-DTD2.dat" );
	check_cdpad->SetOn();
	check_singles->SetOn();
	check_addback->SetOn();
